            ...
            <div className="mb-8 flex justify-between items-end">
                ...
                {!isEditing && (
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl text-slate-600 hover:bg-slate-50 hover:text-blue-600 transition-colors font-medium shadow-sm"
                    >
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                ...
                <div className="px-8 pb-8">
                    ...
                    {isEditing ? (
                        ...
                        <div>
                            <div className="mb-6">
                                <h2 className="text-2xl font-bold text-slate-800">{profile.nombre_completo}</h2>
                            ...
                            <div className="grid gap-6 border-t border-slate-100 pt-6">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-slate-500 font-medium">Miembro desde</p>
